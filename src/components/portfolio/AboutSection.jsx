  ...
  return (
    <section id="about" ref={containerRef} className="relative py-32 md:py-48 bg-black overflow-hidden noise-overlay">
      ...
      <motion.div
        ...
        className="absolute top-1/4 right-0 w-[500px] h-[500px] bg-gradient-to-l from-amber-500/10 to-transparent rounded-full blur-[100px]"
      />
      <motion.div
        animate={{ opacity: [0.2, 0.4, 0.2] }}
        transition={{ duration: 10, repeat: Infinity }}
        className="absolute bottom-1/4 left-0 w-[400px] h-[400px] bg-gradient-to-r from-red-500/10 to-transparent rounded-full blur-[100px]"
      />
